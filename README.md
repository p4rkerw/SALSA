...
Here you will find a workflow and models for analyzing single cell allele-specific expression obtained from 10X Genomics scRNA-seq or multiome datasets. An earlier version of this software was written as part of the following manuscript:
