...
```
All of the steps in this tutorial use this container, which is built on [broadinstitute/gatk:4.2.0.0](https://hub.docker.com/r/broadinstitute/gatk) with additional dependencies pre-installed:
```
GATK 4.2.0.0
bwa 0.7.17
STAR 2.5.1b
