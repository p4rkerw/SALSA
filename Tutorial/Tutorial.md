...
```
# set your scratch space to g/salsa
SCRATCH1=/g/salsa
wget -P $SCRATCH1/cellranger_rna_counts https://cf.10xgenomics.com/samples/cell-exp/3.0.0/pbmc_1k_v3/pbmc_1k_v3_possorted_genome_bam.bam
wget -P $SCRATCH1/cellranger_rna_counts https://cf.10xgenomics.com/samples/cell-exp/3.0.0/pbmc_1k_v3/pbmc_1k_v3_possorted_genome_bam.bam.bai
```
**Usage:**
```
